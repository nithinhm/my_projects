...
final_number = 6   # enter the last number of this branch's last student as in USN (do not include padded zeros)
...
while k <= final_number:
    ...
    captcha_bar = driver.find_element(By.NAME ,'captchacode')
    captcha_bar.click()
    ...
    marks_data = driver.find_element(By.XPATH, '//*[@id="dataPrint"]/div[2]/div/div/div[2]/div[1]/div/div/div[2]/div/div[1]/div[2]')
